...
!(function($) {
  ...
  $(window).resize(function () {
    ...
    if ($(window).width() < 992) {
      $("#qr-code").removeClass("text-right");
      $("#qr-code").addClass("text-left");
      $( "#navbi1" ).removeClass('icon-cente');
      $( "#navbi1 i" ).removeClass('bi bi-box-arrow-in-left mr-1');
      $( "#nava a" ).removeClass();
      
    }
    else {
      $("#qr-code").removeClass("text-left");
      $("#qr-code").addClass("text-right");
      $( "#navbi1" ).addClass('icon-cente');
      $( "#navbi1 i" ).addClass('bi bi-box-arrow-in-left mr-1');
      $( "#nava a" ).addClass('btn-get-started3 scrollto');
    }
  });
//#***add
})(jQuery);