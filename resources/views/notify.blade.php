...
<li class="dropdown notification-list list-inline-item notify">
    <a class="nav-link dropdown-toggle arrow-none waves-effect notify_icon" id="notify_icon" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false" style="display: inline-block;color:#495057;">
    ...
    <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg">
        ...
        <div class="slimscroll notification-item-list notify_body" style="scroll-behavior: smooth;">
            <!-- item-->
