...
<head>
  ...
  <link href="<?php echo url('');?>/assets/web/promote/img/apple-touch-icon.png" rel="apple-touch-icon">
  ...
  <section id="intro">
    ...
    <div class="product-screens">
      ...
      <div class="product-screen-1 wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.6s">
        <img src="<?php echo url('');?>/assets/web/promote/img/product-screen-1.png" alt="">
      </div>

      <div class="product-screen-2 wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.6s">
        <img src="<?php echo url('');?>/assets/web/promote/img/product-screen-2.png" alt="">
      </div>

      <div class="product-screen-3 wow fadeInUp" data-wow-duration="0.6s">
        <img src="<?php echo url('');?>/assets/web/promote/img/product-screen-3.png" alt="">
      </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-5 features-img">
            <img src="<?php echo url('');?>/assets/web/promote/img/product-features.png" alt="" class="wow fadeInLeft">
          </div>
    ...
    <section id="advanced-features">
      ...
      <div class="features-row section-bg">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <img class="advanced-feature-img-right wow fadeInRight" src="<?php echo url('');?>/assets/web/promote/img/advanced-feature-1.jpg" alt="">
      ...
      <div class="features-row">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <img class="advanced-feature-img-left" src="<?php echo url('');?>/assets/web/promote/img/advanced-feature-2.jpg" alt="">
    ...
    <section id="clients">
      <div class="container">
        ...
        <div class="row wow fadeInUp">
          ...
          <div class="col-md-2">
            <img src="<?php echo url('');?>/assets/web/promote/img/clients/client-1.png" alt="">
          </div>

          <div class="col-md-2">
            <img src="<?php echo url('');?>/assets/web/promote/img/clients/client-2.png" alt="">
          </div>

          <div class="col-md-2">
            <img src="<?php echo url('');?>/assets/web/promote/img/clients/client-3.png" alt="">
          </div>

          <div class="col-md-2">
            <img src="<?php echo url('');?>/assets/web/promote/img/clients/client-4.png" alt="">
          </div>

          <div class="col-md-2">
            <img src="<?php echo url('');?>/assets/web/promote/img/clients/client-5.png" alt="">
          </div>

          <div class="col-md-2">
            <img src="<?php echo url('');?>/assets/web/promote/img/clients/client-6.png" alt="">
          </div>
      ...
      <div class="container">
        ...
        <div class="row wow fadeInUp">
          <div class="col-lg-3 col-md-6">
            <div class="member">
              <div class="pic"><img src="<?php echo url('');?>/assets/web/promote/img/team/team-1.jpg" alt=""></div>
              <h4>Walter White</h4>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member">
              <div class="pic"><img src="<?php echo url('');?>/assets/web/promote/img/team/team-2.jpg" alt=""></div>
              <h4>Sarah Jhinson</h4>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member">
              <div class="pic"><img src="<?php echo url('');?>/assets/web/promote/img/team/team-3.jpg" alt=""></div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member">
              <div class="pic"><img src="<?php echo url('');?>/assets/web/promote/img/team/team-4.jpg" alt=""></div>
              <h4>Amanda Jepson</h4>
