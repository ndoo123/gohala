      ...
      <div class="tp-banner" >
        <ul>
          ...
          <li data-transition="slidehorizontal" data-slotamount="5" data-masterspeed="700" > 
            <!-- MAIN IMAGE --> 
            <img src="<?php echo url('assets/web/images/slider/slider-img1.jpg');?>" alt="slidebg1" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat"> 
            <!-- LAYERS --> 
            <!-- LAYER NR. 1 -->
          ...
          <li data-transition="slidehorizontal" data-slotamount="5" data-masterspeed="700" > 
            <!-- MAIN IMAGE --> 
            <img src="<?php echo url('assets/web/images/slider/slider-img2.jpg');?>" alt="slidebg1" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat"> 
            <!-- LAYERS --> 
            <!-- LAYER NR. 1 -->
          ...
          <li data-transition="slidehorizontal" data-slotamount="5" data-masterspeed="700" > 
            <!-- MAIN IMAGE --> 
            <img src="<?php echo url('assets/web/images/slider/slider-img3.jpg');?>" alt="slidebg3" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat"> 
            <!-- LAYERS --> 
            <!-- LAYER NR. 1 -->
...
@section('content')
    ...
    <div class="row">
      <div class="col-sm-4 col-xs-12">
        <div class="jtv-banner-box banner-inner">
          <div class="image"> <a class="jtv-banner-opacity" href="#"><img src="<?php echo url('assets/web/images/top-banner1.jpg');?>" alt=""></a> </div>
      ...
      <div class="col-sm-5 col-xs-12">
        <div class="jtv-banner-box">
          <div class="image"> <a class="jtv-banner-opacity" href="#"><img src="<?php echo url('assets/web/images/top-banner2.jpg');?>" alt=""></a> </div>
          <div class="jtv-content-text">
      ...
      <div class="col-sm-3 col-xs-12">
        <div class="jtv-banner-box banner-inner">
          <div class="image"> <a class="jtv-banner-opacity" href="#"><img src="<?php echo url('assets/web/images/top-banner3.jpg');?>" alt=""></a> </div>
          <div class="jtv-content-text">
            <h3 class="title">New Arrival</h3>
          </div>
        </div>
        <div class="jtv-banner-box banner-inner">
          <div class="image "> <a class="jtv-banner-opacity" href="#"><img src="<?php echo url('assets/web/images/top-banner4.jpg');?>" alt=""></a> </div>
          <div class="jtv-content-text">
        ...
        <div class="col-md-4 col-sm-6">
          <div class="jtv-single-cat">
            ...
            <div class="jtv-product">
              <div class="product-img"> <a href="single_product.html"> <img src="http://via.placeholder.com/700x800" alt=""> <img class="secondary-img" src="http://via.placeholder.com/700x800" alt=""> </a> </div>
        ...
        <div class="col-md-4 col-sm-12 col-xs-12">
          <div class="jtv-service-area"> 
            ...
            <div class="jtv-single-service">
              <div class="service-icon"> <img alt="" src="<?php echo url('assets/web/images/customer-service-icon.png');?>"> </div>
            ...
            <div class="jtv-single-service">
              <div class="service-icon"> <img alt="" src="<?php echo url('assets/web/images/shipping-icon.png');?>"> </div>
              <div class="service-text">
            ...
            <div class="jtv-single-service">
              <div class="service-icon"> <img alt="" src="<?php echo url('assets/web/images/guaratee-icon.png');?>"> </div>
              <div class="service-text">
  ...
  <div id="news_latter_modal" class="modal fade">
