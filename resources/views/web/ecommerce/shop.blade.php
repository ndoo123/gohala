			...
			<div class="container">
				<div class="row small-gutters">
					<div class="col-xl-3 col-lg-3 d-lg-flex align-items-center">
						<div id="logo">
							<a href="index.html"><img src="<?php echo url('');?>/assets/web/img/logo.svg" alt="" width="100" height="35"></a>
						</div>
					</div>
					<nav class="col-xl-6 col-lg-7">
						...
						<div class="main-menu">
							<div id="header_menu">
								<a href="index.html"><img src="<?php echo url('');?>/assets/web/img/logo_black.svg" alt="" width="100" height="35"></a>
								<a href="#" class="open_close" id="close_in"><i class="ti-close"></i></a>
							</div>
							<ul>
								
								<li>
									<a href="blog.html">หน้าแรก</a>
								</li>
								<li>
								...
								<li><span>
									...
									<div id="menu">
										<ul>
											...
											<li><a href="#0"><?php echo $cat->name;?></a></li>
                                            <?php endforeach;?>
	...
	<main>
		<div class="container pt-3">
			...
			<div class="row small-gutters">
                ...
                <div class="col-md-12 text-center" style="min-height:335px">
                    <div class="grid_item">
                        <p>-- ไม่มีสินค้า --</p>
                        </div>
                    </div>
